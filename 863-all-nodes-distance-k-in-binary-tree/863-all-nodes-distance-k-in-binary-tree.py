...
# ref: https://leetcode.com/problems/all-nodes-distance-k-in-binary-tree/discuss/752636/Python-Convert-to-Graph-and-run-BFS-(Detailed-explanation)
class Solution:
    ...
    def distanceK(self, root: TreeNode, target: TreeNode, K: int) -> List[int]:
        ...
        q.append((target, 0))
        # 从目标点开始bfs展开，展开到第K层的时候，就收网把结果加回来
        while q:
            n, d = q.popleft()
            vis.add(n)
